        ...
        if safeArea {
            if bottomToKeyboard {
                addSubview(
                    other,
                    constraints: [
                        other.leadingAnchor.constraint(
                            equalTo: safeAreaLayoutGuide.leadingAnchor,
                            constant: edgeInsets.left),
                        
                        other.topAnchor.constraint(
                            equalTo: safeAreaLayoutGuide.topAnchor,
                            constant: edgeInsets.top),
                        
                        other.trailingAnchor.constraint(
                            equalTo: safeAreaLayoutGuide.trailingAnchor,
                            constant: -edgeInsets.right),
                        
                        other.bottomAnchor.constraint(
            ...
            if bottomToKeyboard {
                addSubview(
                    ...
                    constraints: [
                        ...
                        other.bottomAnchor.constraint(
                            equalTo: keyboardLayoutGuideNoSafeArea.topAnchor,
                            constant: -edgeInsets.bottom)
                    ])
            } else {
                addSubview(
