...
final class LoginSceneView: BaseView {
    ...
    // MARK: - Buttons
    private lazy var loginButton = buildGradientButton(
        with: Localization.login,
        fontSize: Constants.basicButtonTitleFontSize)
    
    private lazy var restorePasswordButton = buildSystemButton(
        with: Localization.restorePassword,
        fontSize: Constants.basicButtonTitleFontSize)
    
    private lazy var createAccountButton = buildSystemButton(
        with: Localization.createAccount,
...
private extension LoginSceneView {
    ...
    func setupLayout() {
        ...
        addSubview(
            substrateView,
            constraints: [
                substrateView.topAnchor.constraint(
                    equalTo: titleLabel.bottomAnchor,
                    constant: Constants.basicSpacing),
                
                substrateView.leadingAnchor.constraint(
                    equalTo: leadingAnchor,
                    constant: Constants.basicEdgeInsets),
                
                substrateView.trailingAnchor.constraint(
                    equalTo: trailingAnchor,
                    constant: -Constants.basicEdgeInsets),
        ...
        addSubview(
            ...
            constraints: [
                ...
                loginButton.bottomAnchor.constraint(
                    equalTo: substrateView.bottomAnchor,
                    constant: -Constants.basicSpacing)
            ])
