...
private extension AppInfoCell {
	...
	func setupLayout() {
		addSubview(appIconImageView, constraints: [
			appIconImageView.heightAnchor.constraint(equalToConstant: 85),
			appIconImageView.widthAnchor.constraint(equalToConstant: 85),
		...
		addSubview(appVersionLabel, constraints: [
			appVersionLabel.topAnchor.constraint(equalTo: appIconImageView.bottomAnchor, constant: 8),
			appVersionLabel.centerXAnchor.constraint(equalTo: centerXAnchor)
		])
		
		addSubview(buildVersionLabel, constraints: [
			buildVersionLabel.topAnchor.constraint(equalTo: appVersionLabel.bottomAnchor, constant: 8),
			buildVersionLabel.centerXAnchor.constraint(equalTo: self.centerXAnchor)
		])
		
		addSubview(companyDescriptionLabel, constraints: [
			companyDescriptionLabel.topAnchor.constraint(equalTo: buildVersionLabel.bottomAnchor, constant: 8),
			companyDescriptionLabel.centerXAnchor.constraint(equalTo: centerXAnchor)
		])
	}
}
