...
private extension CreditsSceneViewModel {
    func updateDatasource() {
        ...
        let appInfoModel = AppInfoCellModel(
            appIcon: appIcon,
        ...
        let socialMediaSection = CreditsSection(
            ...
            items:
                [
                    .listItem(CreditsListCellModel(
                        title: Localization.visitWebsite,
                        item: .website)),
                    
                        .listItem(CreditsListCellModel(
                            title: Localization.followInstagram,
                            item: .instagram)),
                    
                        .listItem(CreditsListCellModel(
                            title: Localization.followTwitter,
                            item: .twitter)),
                    
                        .listItem(CreditsListCellModel(
                            title: Localization.followFb,
                            item: .fb)),
                    
                        .listItem(CreditsListCellModel(
                            title: Localization.followLinkedIn,
                            item: .linkedIn))
                ])
