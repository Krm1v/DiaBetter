...
final class InsulinCell: BaseCollectionViewCell {
    ...
    private lazy var fastInsulinTextfield = buildSystemTextField(keyBoardType: .decimalPad)
    private lazy var basalInsulinTextfield = buildSystemTextField(keyBoardType: .decimalPad)
    ...
    private lazy var hStackForFastInsulin = buildStackView(
        axis: .horizontal,
        alignment: .fill,
        distribution: .fill,
        spacing: Constants.stackViewSmallSpacing)
    
    private lazy var hStackForBasalInsulin = buildStackView(
        axis: .horizontal,
        alignment: .fill,
        distribution: .fill,
        spacing: Constants.stackViewSmallSpacing)
